...
import { Sparkles, Activity, Terminal, Music } from "lucide-react";
import Button from "../ui/Button";
import { MusicSelectionMode } from "../../types";
  ...
  return (
    <div className="w-full border border-slate-200/10 bg-slate-950 rounded-md overflow-hidden font-sans">
        ...
        <div className="flex items-center gap-1.5">
          <span
            className={`w-1.5 h-1.5 rounded-full ${
              isAutoMode ? "bg-[#007acc] animate-pulse" : "bg-slate-700"
            }`}
          />
          <span className="text-[10px] font-mono text-slate-500">{isAutoMode ? "ACTIVE" : "IDLE"}</span>
        </div>
      </div>
      ...
      <div className="p-2 grid gap-2">
        ...
        {/* 🆕 NEW: Music Selection Mode Toggle */}
        <div
          className={`
        ...
        >
          <div className="flex flex-col gap-0.5">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-medium text-slate-200">AI Music Discovery</span>
            </div>
            <span className="text-[10px] text-slate-500 font-mono pl-5">
              {isAiMode ? "ONLINE_SEARCH" : "LOCAL_DATABASE"}
            </span>
          </div>
        ...
        >
          <div className="flex flex-col gap-0.5">
            ...
            <span className="text-[10px] text-slate-500 font-mono pl-5">7x STRATEGIC SEQUENCES</span>
          </div>
